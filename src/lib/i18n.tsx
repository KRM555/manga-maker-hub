...
const translations = {
  en: {
    ...
    menu: "Menu",
    menuDesc: "Quick actions & settings",
    save: "Save",
    apiKeySaved: "API key saved",
    apiKeySavedDesc: "Your Gemini API key is stored in this browser and will load automatically.",
    apiKeySectionTitle: "Gemini API Key",
    apiKeySectionDesc: "Saved locally — you won't need to re-enter it.",
    ...
    discord: "Discord",
    tooltipDiscord: "Join our Discord community",
  ...
  ar: {
    ...
    menu: "القائمة",
    menuDesc: "إجراءات سريعة وإعدادات",
    save: "حفظ",
    apiKeySaved: "تم حفظ المفتاح",
    apiKeySavedDesc: "تم تخزين مفتاح Gemini API في هذا المتصفح وسيُحمَّل تلقائياً.",
    apiKeySectionTitle: "مفتاح Gemini API",
    apiKeySectionDesc: "يُحفظ محلياً — لن تحتاج لإدخاله مجدداً.",
    ...
    discord: "ديسكورد",
    tooltipDiscord: "انضم إلى مجتمعنا على ديسكورد",
    howItWorks: "كيف يعمل",
